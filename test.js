...
//   const getColumnData = async (newValue, type) => {
//     console.log("previous selected value 1001  ",selectrowvalue)
...
//       // Place your code that depends on the updated state here
//       console.log("updated selected value 1001 ",updatedValues)
//       getFilterData("", "", "", updatedValues);
...
//           sendColumn[element]=element
//       });
//       let column = await tableData(response.data.results, sendColumn);
...
//        setSelectrowValue(temp)
//         let column = await tableData(response.data.results, temp);
...
//     console.log(" createColumnData 2",columns)
//     columns=Object.keys(columns)
    
//     // columns=createColumnData
//     // console.log(" createColumnData",columns,"and",createColumnData,selectrowvalue)
//     let columnsValue = [];
//     let precolumn = [];
...
//     console.log("selectrowvalue", selectrowvalue);
...
let test=["item","customer","location"]
